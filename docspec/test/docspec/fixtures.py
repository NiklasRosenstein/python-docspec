...
def module() -> docspec.Module:
  module = docspec.Module(loc, 'a', None, [
    docspec.Class(loc, 'foo', docspec.Docstring(loc, 'This is class foo.'), [
...
def typed_module() -> docspec.Module:
  module = docspec.Module(docspec.Location('test.py', 0), 'a', None, [
    ...
    docspec.Class(docspec.Location('test.py', 2), 'foo', docspec.Docstring(docspec.Location('test.py', 3), 'This is class foo.'), [
